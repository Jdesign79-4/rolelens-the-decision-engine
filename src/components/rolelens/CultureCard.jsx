    ...
    <motion.div
      ...
      animate={{
        x: isCalm 
          ...
          : ['-15%', '5%', '25%', '15%', '45%', '35%', '65%', '55%', '85%', '105%'],
        y: isCalm 
          ? ['45%', '35%', '45%', '35%', '45%', '35%', '45%', '45%'] 
          : ['40%', '55%', '30%', '50%', '25%', '55%', '35%', '60%', '40%', '50%'],
        opacity: [0, 1, 1, 1, 1, 1, 1, 0],
        rotate: isCalm 
          ? [45, 35, 45, 35, 45, 35, 45, 50] 
          : [30, 50, 25, 60, 20, 65, 30, 70, 25, 45]
      }}
      transition={{
        ...
        times: isCalm ? [0, 0.14, 0.28, 0.42, 0.56, 0.70, 0.84, 1] : [0, 0.11, 0.22, 0.33, 0.44, 0.55, 0.66, 0.77, 0.88, 1]
      }}
    >
      {/* Rake assembly */}
